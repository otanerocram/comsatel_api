...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        ...
                        <p class="text-muted">En la columna "Estado" se muestran los códigos de respuesta recibidos por el programa de transmisión Echelon hacia Comsatel.</p>
                    </div>
    ...
    <main role="main">
        <div class"well">
            ...
            $result = mysqli_query($con, "SELECT `posicionId`, `vehiculoId`, `velocidad`, `satelites`, `rumbo`, `latitud`, `longitud`, `altitud`, `gpsDateTime`, `statusCode`, `ignition`, `odometro`, `horometro`, `nivelBateria`, `estado` FROM `Comsatel` ORDER BY `posicionId` DESC LIMIT 100;");
